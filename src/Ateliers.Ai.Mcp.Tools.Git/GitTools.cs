...
public class GitTools
{
        ...
        string repositoryKey)
    {
        try
        {
            var repositorySummary = _gitService.GetRepositorySummary(repositoryKey);
            ...
            var result = await _gitService.PullAsync(repositoryKey, repositorySummary.LocalPath);
        ...
        string message)
    {
        try
        {
            ...
            var result = await _gitService.CommitAllAsync(
                repositoryKey,
                repositorySummary.LocalPath, 
                message);
        ...
        string repositoryKey)
    {
        try
        {
            ...
            var result = await _gitService.PushAsync(repositoryKey, repositorySummary.LocalPath);
        ...
        string message)
    {
        try
        {
            ...
            var result = await _gitService.CommitAllAndPushAsync(
                repositoryKey,
                repositorySummary.LocalPath, 
                message);
        ...
        string? message = null)
    {
        try
        {
            ...
            var result = await _gitService.CreateTagAsync(
                repositoryKey,
                repositorySummary.LocalPath, 
                tagName, 
                message);
        ...
        string tagName)
    {
        try
        {
            ...
            var result = await _gitService.PushTagAsync(
                repositoryKey,
                repositorySummary.LocalPath, 
                tagName);
        ...
        string? message = null)
    {
        try
        {
            ...
            var result = await _gitService.CreateAndPushTagAsync(
                repositoryKey,
                repositorySummary.LocalPath, 
                tagName, 
                message);
